...
def load_ap_agent_invoices(limit: int = 50) -> pd.DataFrame:
    return _read_dataframe(
        ...
        SELECT
            i.invoice_number,
            i.vendor_name,
            i.extracted_vendor_number,
            i.resolved_vendor_number,
            i.vendor_match_method,
            i.vendor_match_status,
            i.po_number,
            i.raw_invoice_date,
            i.invoice_date,
            i.raw_due_date,
            i.due_date,
            i.date_parse_warning,
            i.currency,
            i.extracted_currency,
            i.resolved_currency,
            i.currency_resolution_method,
            i.total_amount,
            i.extraction_confidence,
            i.extraction_confidence_source,
            i.extraction_field_confidence,
            i.extraction_provider,
            i.extraction_model,
            i.extraction_attempt_number,
            i.extraction_retry_count,
            i.extraction_warnings,
            i.extraction_review_status,
